...
# class ChatRoom(models.Model):
#     participant_a = models.ForeignKey(User, related_name='chats_a', on_delete=models.CASCADE)
#     participant_b = models.ForeignKey(User, related_name='chats_b', on_delete=models.CASCADE)
#     created_at = models.DateTimeField(auto_now_add=True)
